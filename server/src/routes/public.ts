...
import { fetchPublicAlumni, fetchPublicAlumniFilterOptions } from '../controllers/alumniController';
...
router.get('/alumni/filter-options', requireStudentAccess, fetchPublicAlumniFilterOptions);
